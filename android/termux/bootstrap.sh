...
pkg update -y
pkg install -y git nodejs python python-pip clang make pkg-config openssh termux-tools curl termux-api libusb
...
python -m pip install "platformio==6.2.0" "esptool==4.12.0" "pyserial==3.5" "nrflash==1.2.0"
